...
export default function FloatingAskAI() {
  ...
  return (
    <button
      type="button"
      onClick={openChat}
      className="fixed top-4 right-5 z-50 inline-flex items-center gap-2 rounded-full border border-sky-400/40 bg-[#0c1017]/90 px-3.5 py-1.5 text-xs font-semibold text-sky-200 shadow-[0_0_25px_rgba(56,189,248,0.25)] backdrop-blur-xl transition-all duration-200 hover:border-sky-300 hover:bg-sky-500/20 hover:text-white hover:scale-105 active:scale-95 cursor-pointer sm:top-5 sm:right-6 sm:px-4 sm:py-2"
